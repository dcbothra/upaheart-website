          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <img 
                ...
                className="w-full h-full object-cover rounded-sm grayscale opacity-60 mix-blend-lighten" 
                alt="3D printing process" 
              />
              <div className="absolute inset-0 border border-white/10 m-8" />
              <div className="absolute bottom-12 -right-6 md:-right-12 bg-white text-warm-900 p-8 max-w-xs shadow-2xl">
                ...
                <p className="text-[10px] uppercase tracking-widest font-bold mt-4 opacity-50">— Founder, UpaHeart</p>
              </div>
            </motion.div>
